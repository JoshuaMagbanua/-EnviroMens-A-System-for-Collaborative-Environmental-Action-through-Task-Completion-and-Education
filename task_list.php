            ...
            <div class="task-container">
                ...
                <?php if (!empty($tasks)): ?>
                    <?php foreach($tasks as $task): ?>
                        <div class="task-card" onclick="showTaskDetails(<?php echo htmlspecialchars(json_encode($task)); ?>)">
                            <div class="task-info">
            ...
            .then(data => {
                if (data.success) {
                    Swal.fire({
                        icon: 'success',
                        title: 'Task Joined!',
                        text: 'The task has been added to your profile.'
                    });
                } else {
                    Swal.fire({
                        icon: 'error',
